 ...
 * 
 */
public class UnCheckInterceptor extends ControllerInterceptor {
	private static final Logger LOG = LoggerFactory.getLogger(UnCheckInterceptor.class);
	@Autowired
	...
	@Override
	protected Boolean resolveUserNotAuthenticated(HttpServletRequest request, HttpServletResponse response, String requestUrl)
			throws IOException {
		return false;
	}
